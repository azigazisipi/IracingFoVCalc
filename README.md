...
1. Download the latest release from the [Releases]([https://github.com/azigazisipi/IracingFoVCalc](https://github.com/azigazisipi/IracingFoVCalc/releases/tag/1.0.0)) section.
